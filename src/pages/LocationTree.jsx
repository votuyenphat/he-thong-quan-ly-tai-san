...
const LEVEL_TYPES = {
  0: { type: 'CAMPUS', label: 'Cơ sở', icon: Building, color: '#2563eb' },
  1: { type: 'AREA', label: 'Khu/Tòa', icon: Layers, color: '#059669' },
  2: { type: 'FLOOR', label: 'Tầng', icon: MapPin, color: '#d97706' },
  3: { type: 'ROOM', label: 'Phòng', icon: DoorOpen, color: '#6366f1' }
};
